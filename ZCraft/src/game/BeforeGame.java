...
public class BeforeGame {
	...
	public void render(Graphics g) {
		...
		g2d.setFont(f1);
		g2d.drawString(title, game.getWidth()/10 * 3, game.getHeight()/10);
		...
		g2d.drawString("When game has loaded", game.getWidth()/15, game.getHeight()/4 * 3);
		g2d.drawString("Press 1 to start", game.getWidth()/5, game.getHeight()/8 * 7);
